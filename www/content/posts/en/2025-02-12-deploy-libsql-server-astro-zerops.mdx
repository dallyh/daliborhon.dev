...
<Callout type="note" title="Running commands with Powershell" >
...
![Page with data](../assets/deploy-libsql-server-with-astro-on-zerops/zerops-astro-libsql-pg-data.png)
